  ...
  data: {
    ...
    datasets: [
      ...
      // },
      {
        ...
        data: [
          13.3, 71, 382.8, 165, 314.3, 18.6, 122.4, 25.7, 405.5, 4.2, 802.1,
          217.1, 810.6, 27.75, 11.2, 57, 23.1, 30.7, 728.9, 589.3, 44.4,
        ],
      },
      // {
      //   label: "AVG of NH3",
...
//   return (
//     <>
//       <img src="images/water/WGraph2.png" className="air-graph1-img"></img>
//     </>
//   );
// };
